			...
			.done((response) => {
				...
				function iconSelector(location, icon) {
					switch (icon) {
						...
						case "02d":
							location.append(
								"<div class='partly_cloudy_night'></div>"
							);

							$(
								"<div class='partly_cloudy_night__moon'></div>"
							).appendTo(location.children());
							$(
								"<div class='partly_cloudy_night__cloud'></div>"
							).appendTo(location.children());
							break;
						case "02n":
							location.append(
								"<div class='partly_cloudy'></div>"
							);
							$(
